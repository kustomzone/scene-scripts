...
json = JSON.parse(open("https://api.imgur.com/3/gallery.json").readlines.join)
...
File.open("./scenes/imgur.xml", "w") { |f| f.write xml }

puts "Visit /imgur.xml to see the gallery."
